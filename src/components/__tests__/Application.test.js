...
import { render, waitForElement, getAllByTestId, fireEvent, getByAltText, getByPlaceholderText, getByText, queryByText, queryByAltText } from "@testing-library/react";
...
describe("Application", () => {
  ...
  it("shows the save error when failing to save an appointment", async () => {
    ...
    fireEvent.input(getByPlaceholderText(container, "Enter Student Name"), { target: { value: "John Doe" } });
